...
export class HomePageComponent implements OnInit, OnChanges {
  ...
  constructor() {
    ...
    // setTimeout(() => {
    //   // No es recomendable mezclar señales con asignaciones tradicionales. El uso de señales es más eficiente y es hacia donde Angular va...
    //   this.signalProperty.set('Hola Juan Carloooos...');
    // }, 2000);
  }

  changeTraditionalProperty() {
    this.traditionalProperty = 'Diego Scifo';
  }
  changeSignalProperty() {
    this.signalProperty.set('Diego Scifo');
  }
